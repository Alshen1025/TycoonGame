	...
	public void OnClickPurchaseButton()
	{
		...
		switch (_type)
		{
			case EUpgradeEmployeePopupItemType.Speed:
				{
					GameManager.Instance.BroadcastEvent(EEventType.WorkerSpeedUpgrade);
					Debug.Log("BroadcastEvent WorkerSpeedUpgrade");
					GameManager.Instance.UpgradeEmployeePopup.gameObject.SetActive(false);
				}
				break;
			case EUpgradeEmployeePopupItemType.Capacity:
				{
					GameManager.Instance.BroadcastEvent(EEventType.WorkerCapacityUpgrade);
					Debug.Log("BroadcastEvent WorkerCapacityUpgrade");
					GameManager.Instance.UpgradeEmployeePopup.gameObject.SetActive(false);
				}
				break;
			case EUpgradeEmployeePopupItemType.Hire:
				{
					...
					Debug.Log("BroadcastEvent HireWorker");
					GameManager.Instance.UpgradeEmployeePopup.gameObject.SetActive(false);
				}
				break;
		}
